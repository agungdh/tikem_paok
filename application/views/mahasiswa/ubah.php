      ...
      <div class="tile-body">
        <form method="post" action="<?php echo base_url('mahasiswa/aksi_ubah'); ?>">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" required placeholder="Masukan NIM" name="data[nim]" value="<?php echo $data['mahasiswa']->nim; ?>">
          </div>
              ...
              foreach ($this->db->get('fakultas')->result() as $item_fakultas) {
                ...
                <optgroup label="<?php echo $item_fakultas->nama; ?>">
                  ...
                  foreach ($this->db->get_where('prodi', ['fakultas_id' => $item_fakultas->id])->result() as $item_prodi) {
                    if ($item_prodi->id == $data['mahasiswa']->prodi_id) {
                      ?>
                      <option selected value="<?php echo $item_prodi->id; ?>"><?php echo $item_prodi->nama; ?></option>
                      <?php
                    } else {
                      ?>
